...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_userprofile', 'telephone',
                      self.gf('django.db.models.fields.TextField')(max_length=13, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.telephone'
        db.delete_column('accounts_userprofile', 'telephone')
    ...
    models = {
        'accounts.userprofile': {
            ...
            'telephone': ('django.db.models.fields.TextField', [], {'max_length': '13', 'null': 'True', 'blank': 'True'}),
