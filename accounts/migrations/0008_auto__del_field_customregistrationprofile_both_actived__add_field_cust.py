...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CustomRegistrationProfile.both_actived'
        db.delete_column('accounts_customregistrationprofile', 'both_actived')
    ...
    def backwards(self, orm):
        # Adding field 'CustomRegistrationProfile.both_actived'
        db.add_column('accounts_customregistrationprofile', 'both_actived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
