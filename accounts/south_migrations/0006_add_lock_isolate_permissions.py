...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        ct, created = orm['contenttypes.ContentType'].objects.get_or_create(
            model='instance', app_label='ganeti') # model must be lowercase!
        perm, created = orm['auth.permission'].objects.get_or_create(
            content_type=ct, codename='can_lock', defaults=dict(name=u'Can Lock'))

        ct, created = orm['contenttypes.ContentType'].objects.get_or_create(
            model='instance', app_label='ganeti') # model must be lowercase!
        perm, created = orm['auth.permission'].objects.get_or_create(
            content_type=ct, codename='can_isolate', defaults=dict(name=u'Can Isolate'))
