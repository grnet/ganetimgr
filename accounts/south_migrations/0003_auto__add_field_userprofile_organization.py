...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_userprofile', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apply.Organization'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.organization'
        db.delete_column('accounts_userprofile', 'organization_id')
