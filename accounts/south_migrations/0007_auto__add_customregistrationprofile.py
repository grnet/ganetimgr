...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CustomRegistrationProfile'
        db.create_table('accounts_customregistrationprofile', (
            ...
            ('admin_activation_key', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('admin_activated', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('both_actived', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('accounts', ['CustomRegistrationProfile'])


    def backwards(self, orm):
        # Deleting model 'CustomRegistrationProfile'
        db.delete_table('accounts_customregistrationprofile')


    models = {
        'accounts.customregistrationprofile': {
            'Meta': {'object_name': 'CustomRegistrationProfile', '_ormbases': ['registration.RegistrationProfile']},
            'admin_activated': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'admin_activation_key': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'both_actived': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
