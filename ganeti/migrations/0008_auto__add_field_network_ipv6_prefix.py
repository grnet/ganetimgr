...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Network.ipv6_prefix'
        db.add_column('ganeti_network', 'ipv6_prefix', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Network.ipv6_prefix'
        db.delete_column('ganeti_network', 'ipv6_prefix')
    ...
    models = {
        ...
        'ganeti.network': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ipv6_prefix': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
