...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InstanceAction.operating_system'
        db.add_column('ganeti_instanceaction', 'operating_system',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InstanceAction.operating_system'
        db.delete_column('ganeti_instanceaction', 'operating_system')
