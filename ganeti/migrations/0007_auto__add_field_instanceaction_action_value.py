...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InstanceAction.action_value'
        db.add_column('ganeti_instanceaction', 'action_value', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'InstanceAction.action_value'
        db.delete_column('ganeti_instanceaction', 'action_value')
