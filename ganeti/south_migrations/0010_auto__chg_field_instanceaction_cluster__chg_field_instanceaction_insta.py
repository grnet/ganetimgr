...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InstanceAction.cluster'
        ...
        # Changing field 'InstanceAction.instance'
        db.alter_column('ganeti_instanceaction', 'instance', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'InstanceAction.cluster'
        db.alter_column('ganeti_instanceaction', 'cluster_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ganeti.Cluster']))

        # Changing field 'InstanceAction.instance'
        db.alter_column('ganeti_instanceaction', 'instance', self.gf('django.db.models.fields.CharField')(max_length=255))
