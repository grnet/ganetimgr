...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Network.ipv6_prefix'
        db.alter_column('ganeti_network', 'ipv6_prefix', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Network.ipv6_prefix'
        db.alter_column('ganeti_network', 'ipv6_prefix', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
