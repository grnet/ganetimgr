...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('auditlog_auditentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('requester', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('ipaddress', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ...
        db.send_create_signal('auditlog', ['AuditEntry'])


    def backwards(self, orm):
        # Deleting model 'AuditEntry'
        db.delete_table('auditlog_auditentry')
