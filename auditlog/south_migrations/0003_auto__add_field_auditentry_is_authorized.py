...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AuditEntry.is_authorized'
        db.add_column('auditlog_auditentry', 'is_authorized',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AuditEntry.is_authorized'
        db.delete_column('auditlog_auditentry', 'is_authorized')


    models = {
        'auditlog.auditentry': {
            'Meta': {'object_name': 'AuditEntry'},
            ...
            'ipaddress': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'is_authorized': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
