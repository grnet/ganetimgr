...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'InstanceApplication.cluster'
        db.delete_column('apply_instanceapplication', 'cluster_id')
    
    
    def backwards(self, orm):
        
        # Adding field 'InstanceApplication.cluster'
        db.add_column('apply_instanceapplication', 'cluster', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ganeti.Cluster'], null=True, blank=True), keep_default=False)
    ...
    models = {
        'apply.instanceapplication': {
            ...
            'cookie': ('django.db.models.fields.CharField', [], {'default': "'AYJsh4T4yg'", 'max_length': '255'}),
