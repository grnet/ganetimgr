...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SshPublicKey.fingerprint'
        db.add_column('apply_sshpublickey', 'fingerprint', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SshPublicKey.fingerprint'
        db.delete_column('apply_sshpublickey', 'fingerprint')
