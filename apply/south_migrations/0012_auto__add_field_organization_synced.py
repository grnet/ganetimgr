...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.synced'
        db.add_column('apply_organization', 'synced',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.synced'
        db.delete_column('apply_organization', 'synced')
    ...
    models = {
        'apply.instanceapplication': {
            ...
            'cookie': ('django.db.models.fields.CharField', [], {'default': "'Jz6km9Zg6e'", 'max_length': '255'}),
