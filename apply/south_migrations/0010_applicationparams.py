...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for instappl in orm.InstanceApplication.objects.all():
            try:
                params = {}
                params['network'] = instappl.network.link
                params['mode'] = instappl.network.mode
                params['cluster'] = instappl.network.cluster.slug
                instappl.instance_params = params
                instappl.save()
            except:
                pass
    ...
    models = {
        'apply.instanceapplication': {
            ...
            'cookie': ('django.db.models.fields.CharField', [], {'default': "'cv4cEPpwcK'", 'max_length': '255'}),
