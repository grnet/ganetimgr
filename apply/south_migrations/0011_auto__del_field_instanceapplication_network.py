...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('apply_instanceapplication', 'network',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'network', null=True, to=orm['ganeti.Network'], blank=True),
                      keep_default=False)
    ...
    models = {
        'apply.instanceapplication': {
            ...
            'cookie': ('django.db.models.fields.CharField', [], {'default': "'WkzdatpsKH'", 'max_length': '255'}),
