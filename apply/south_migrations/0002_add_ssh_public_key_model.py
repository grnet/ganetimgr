...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('apply_sshpublickey', (
            ('key_type', self.gf('django.db.models.fields.CharField')(max_length=12)),
        ...
        db.send_create_signal('apply', ['SshPublicKey'])

        # Deleting field 'InstanceApplication.ssh_pubkey'
        db.delete_column('apply_instanceapplication', 'ssh_pubkey')
    
    
    def backwards(self, orm):
        
        # Deleting model 'SshPublicKey'
        db.delete_table('apply_sshpublickey')

        # Adding field 'InstanceApplication.ssh_pubkey'
        db.add_column('apply_instanceapplication', 'ssh_pubkey', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
