...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InstanceApplication.admin_comments'
        db.add_column('apply_instanceapplication', 'admin_comments', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'InstanceApplication.admin_comments'
        db.delete_column('apply_instanceapplication', 'admin_comments')
    ...
    models = {
        'apply.instanceapplication': {
            ...
            'cookie': ('django.db.models.fields.CharField', [], {'default': "'AXPkuaUKLN'", 'max_length': '255'}),
